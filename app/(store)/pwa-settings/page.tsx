  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-sienna-500 hover:text-sienna-600 mb-6 whitespace-nowrap"
        >
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
              <div className="w-10 h-10 bg-sienna-50 rounded-full flex items-center justify-center">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              ...
              {notificationPermission === 'granted' && (
                <div className="bg-cream-100 border border-sienna-100 rounded-xl p-4">
                  <p className="text-sm text-sienna-600 font-medium mb-2">You will receive notifications for:</p>
                  <ul className="space-y-1 text-sm text-sienna-500">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-cream-100 rounded-xl">
                <div className="flex items-center gap-3 mb-2">
                  <i className="ri-rocket-line text-sienna-500 text-xl"></i>
                  <span className="font-semibold text-ink-900">Fast Loading</span>
                </div>
                <p className="text-sm text-sienna-600">Instant page loads with smart caching</p>
              </div>
