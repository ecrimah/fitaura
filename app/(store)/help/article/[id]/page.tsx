          ...
          <div className="bg-white rounded-xl shadow-sm p-8 mb-6">
            <div className="mb-6 pb-6 border-b border-gray-200">
              <div className="flex items-center space-x-3 mb-4">
                <span className="px-3 py-1 bg-sienna-50 text-sienna-500 rounded-full text-sm font-semibold whitespace-nowrap">
                  {article.category}
                </span>
            ...
            {!showFeedback ? (
              <div className="flex space-x-4">
                <button
                  ...
                  className="flex-1 py-3 px-6 border-2 border-sienna-500 text-sienna-500 hover:bg-sienna-500 hover:text-white rounded-lg font-semibold transition-colors whitespace-nowrap"
                >
                ...
                {wasHelpful ? (
                  <>
                    <div className="w-16 h-16 flex items-center justify-center bg-sienna-50 rounded-full mx-auto mb-4">
                      <i className="ri-check-line text-3xl text-sienna-500"></i>
                    </div>
                  ...
                  <>
                    <div className="w-16 h-16 flex items-center justify-center bg-sienna-50 rounded-full mx-auto mb-4">
                      <i className="ri-customer-service-line text-3xl text-sienna-500"></i>
                    </div>
                    <p className="text-lg font-semibold text-gray-900 mb-2">
                    ...
                    <Link
                      href="/support/ticket"
                      className="inline-block bg-sienna-500 hover:bg-sienna-600 text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
                    >
                      Contact Support
                    </Link>
                  </>
              ...
              {relatedArticles.map((related) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    <i className="ri-file-text-line text-xl text-sienna-500"></i>
                    <div>
