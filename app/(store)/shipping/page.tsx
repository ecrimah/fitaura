...
export default function ShippingPage() {
  const deliveryOptions = [
    {
      ...
      cost: '$8 CAD',
      description: 'Tracked Canada Post delivery across Canada.',
      icon: 'ri-truck-line'
    },
    {
      ...
      cost: '$18 CAD',
      description: 'Priority delivery for orders placed before 2pm MT.',
      icon: 'ri-rocket-line'
    },
    {
      type: 'Calgary Local',
      time: 'Same / Next Day',
      cost: '$6 CAD',
      description: 'Local delivery within the Calgary metro area.',
  ...
  const zones = [
    {
      zone: 'Zone 1',
      areas: 'Calgary metro area',
      standard: '1-2 days',
      express: 'Same day'
    },
    {
      zone: 'Zone 2',
      areas: 'Alberta, BC, Saskatchewan',
      standard: '2-3 days',
      express: 'Next day'
    },
    {
      zone: 'Zone 3',
      areas: 'Manitoba, Ontario, Quebec',
      standard: '3-5 days',
      express: '1-2 days'
    },
    {
      zone: 'Zone 4',
      areas: 'Maritimes, Territories',
      standard: '5-7 days',
      express: '2-3 days'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Fast, reliable delivery across Canada. Free standard shipping on orders over $120 CAD.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {deliveryOptions.map((option, index) => (
              <div key={index} className="bg-white border-2 border-gray-200 p-8 rounded-2xl hover:border-sienna-500 hover:shadow-lg transition-all">
                <div className="w-14 h-14 bg-sienna-50 rounded-full flex items-center justify-center mb-6">
                  <i className={`${option.icon} text-2xl text-sienna-500`}></i>
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">{option.type}</h3>
                <div className="text-sienna-500 font-bold text-xl mb-2">{option.cost}</div>
        ...
        <div className="bg-cream-100 border-2 border-sienna-100 rounded-2xl p-8 mb-16 text-center">
          ...
          <p className="text-lg text-gray-600">
            Spend $120 CAD or more and get <span className="font-bold text-sienna-500">FREE standard delivery</span> anywhere in Canada
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-10 h-10 bg-sienna-50 rounded-full flex items-center justify-center">
                  <span className="font-bold text-sienna-500">1</span>
                </div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-10 h-10 bg-sienna-50 rounded-full flex items-center justify-center">
                  <span className="font-bold text-sienna-500">2</span>
                </div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-10 h-10 bg-sienna-50 rounded-full flex items-center justify-center">
                  <span className="font-bold text-sienna-500">3</span>
                </div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-10 h-10 bg-sienna-50 rounded-full flex items-center justify-center">
                  <span className="font-bold text-sienna-500">4</span>
                </div>
                <div>
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 space-y-6">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                  <i className="ri-calendar-line text-sienna-500"></i>
                  Business Days
                </h3>
                <p className="text-gray-600 leading-relaxed text-sm">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                  <i className="ri-phone-line text-sienna-500"></i>
                  Delivery Contact
                </h3>
                <p className="text-gray-600 leading-relaxed text-sm">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                  <i className="ri-home-line text-sienna-500"></i>
                  Failed Deliveries
                </h3>
                <p className="text-gray-600 leading-relaxed text-sm">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                  <i className="ri-secure-payment-line text-sienna-500"></i>
                  Package Security
                </h3>
                <p className="text-gray-600 leading-relaxed text-sm">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="w-12 h-12 bg-sienna-50 rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="ri-checkbox-circle-line text-2xl text-sienna-500"></i>
              </div>
            ...
            <div className="text-center">
              <div className="w-12 h-12 bg-sienna-50 rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="ri-gift-line text-2xl text-sienna-500"></i>
              </div>
          ...
          <div className="mt-8 text-center">
            <Link
              href="/order-tracking"
              className="inline-flex items-center gap-2 bg-sienna-500 text-white px-8 py-4 rounded-full font-medium hover:bg-sienna-600 transition-colors whitespace-nowrap"
            >
        ...
        <div className="bg-gradient-to-br from-sienna-500 to-ink-900 rounded-2xl p-8 text-white text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Link
              href="/faqs"
              className="inline-flex items-center gap-2 bg-sienna-500 text-white px-6 py-3 rounded-full font-medium hover:bg-sienna-500 transition-colors whitespace-nowrap"
            >
              View FAQs
            </Link>
          </div>
