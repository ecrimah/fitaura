...
export default function OrderHistory() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'shipped':
        return 'bg-sienna-50 text-sienna-500';
      case 'processing':
  ...
  if (orders.length === 0) {
    return (
      <div className="py-12 text-center bg-white rounded-lg border border-gray-200">
        ...
        <Link href="/shop" className="inline-block bg-sienna-500 text-white px-6 py-2 rounded-lg font-medium hover:bg-sienna-600 transition-colors">
          Go to Shop
        </Link>
      </div>
    );
              ...
              <div className="flex flex-col sm:flex-row flex-wrap items-start sm:items-center justify-between gap-4">
                <div className="flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-4 sm:gap-6 w-full sm:w-auto">
                  ...
                  <div className="w-full sm:w-auto">
                    ...
                    <p className="font-bold text-sienna-500">${order.total.toFixed(2)}</p>
                  </div>
                </div>
                <div className="w-full sm:w-auto">
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 pt-4 border-t border-gray-200">
                <Link
                  ...
                  className="flex-1 sm:flex-none text-center px-4 py-2 bg-sienna-500 text-white rounded-lg font-semibold hover:bg-sienna-600 transition-colors whitespace-nowrap"
                >
