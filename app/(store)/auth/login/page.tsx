      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 text-sienna-500 rounded focus:ring-sienna-500"
                />
                <span className="text-sm text-gray-700">Remember me</span>
              </label>
              <Link href="/auth/forgot-password" className="text-sm text-sienna-500 hover:text-ink-900 font-medium whitespace-nowrap">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-8 text-center text-gray-600">
            ...
            <Link href="/auth/signup" className="text-sienna-500 hover:text-ink-900 font-semibold whitespace-nowrap">
              Create one now
            </Link>
          </p>
        </div>
