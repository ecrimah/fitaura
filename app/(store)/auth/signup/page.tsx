    ...
    return (
      <main className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6">
        <div className="max-w-md w-full text-center">
          <div className="w-20 h-20 bg-sienna-50 rounded-full flex items-center justify-center mx-auto mb-6">
            <i className="ri-mail-send-line text-4xl text-sienna-500"></i>
          </div>
          ...
          <Link href="/auth/login" className="inline-block bg-sienna-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-sienna-600 transition-colors">
            Back to Login
          </Link>
        </div>
      </main>
        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 pr-12 border-2 rounded-lg focus:ring-2 focus:ring-sienna-500 focus:border-sienna-500 ${errors.password ? 'border-red-500' : 'border-gray-300'
                    }`}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 pr-12 border-2 rounded-lg focus:ring-2 focus:ring-sienna-500 focus:border-sienna-500 ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'
                    }`}
            ...
            <div>
              <label className="flex items-start space-x-3 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 mt-1 text-sienna-500 rounded focus:ring-sienna-500"
                />
                <span className="text-sm text-gray-700">
                  I agree to the{' '}
                  <Link href="/terms" className="text-sienna-500 hover:text-ink-900 font-medium whitespace-nowrap">
                    Terms & Conditions
                  </Link>
                  {' '}and{' '}
                  <Link href="/privacy" className="text-sienna-500 hover:text-ink-900 font-medium whitespace-nowrap">
                    Privacy Policy
                  </Link>
                </span>
              </label>
            ...
            <button
              ...
              className="w-full bg-sienna-500 hover:bg-sienna-600 text-white py-4 rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap cursor-pointer"
            >
              {isLoading || verifying ? (
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              ...
              <button
                ...
                className="flex items-center justify-center space-x-2 border-2 border-gray-200 bg-gray-50 py-3 rounded-lg cursor-not-allowed opacity-60"
              >
                <i className="ri-facebook-fill text-xl text-sienna-500 grayscale opacity-50"></i>
          ...
          <p className="mt-8 text-center text-gray-600">
            ...
            <Link href="/auth/login" className="text-sienna-500 hover:text-ink-900 font-semibold whitespace-nowrap">
              Sign in
            </Link>
          </p>
        </div>
