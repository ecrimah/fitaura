...
export default function MyTicketsPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'open': return 'bg-sienna-50 text-sienna-500';
      case 'in_progress': return 'bg-amber-100 text-amber-700';
      case 'resolved': return 'bg-sienna-50 text-sienna-500';
  ...
  const getPriorityColor = (priority: string) => {
    switch (priority) {
      ...
      case 'normal': return 'text-sienna-500';
        ...
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="space-y-4">
              {filteredTickets.map((ticket) => (
                <Link
                  ...
                  className="block bg-white rounded-xl shadow-sm p-6 hover:shadow-lg transition-all border-2 border-transparent hover:border-sienna-500"
                >
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="w-12 h-12 flex items-center justify-center bg-sienna-50 rounded-lg mb-4">
                <i className="ri-time-line text-2xl text-sienna-500"></i>
              </div>
              <h3 className="font-bold text-gray-900 mb-2">Response Time</h3>
              <p className="text-2xl font-bold text-sienna-500 mb-1">24 hours</p>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <p className="text-2xl font-bold text-sienna-500 mb-1">95%</p>
