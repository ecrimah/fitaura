...
export default function CustomerInsightsPage() {
  ...
  const getSegmentBadge = (segment: string) => {
    const badges: any = {
      vip: 'bg-sienna-50 text-sienna-500',
      returning: 'bg-sienna-50 text-sienna-500',
  ...
  const getRiskBadge = (risk: string) => {
    const badges: any = {
      low: 'bg-sienna-50 text-sienna-500',
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 flex items-center justify-center bg-sienna-50 rounded-lg">
                <i className="ri-vip-crown-line text-2xl text-sienna-500"></i>
              </div>
            </div>
            <p className="text-sm text-gray-600 mb-1">VIP Customers</p>
            <p className="text-3xl font-bold text-gray-900">{stats.vip}</p>
            <p className="text-sm text-sienna-500 font-semibold mt-2">Spent &gt; $1,000</p>
          </div>

          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 flex items-center justify-center bg-sienna-50 rounded-lg">
                <i className="ri-refresh-line text-2xl text-sienna-500"></i>
              </div>
            </div>
            ...
            <p className="text-sm text-sienna-500 font-semibold mt-2">More than 1 order</p>
          </div>
              ...
              <div key={customer.id} className="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-start space-x-4">
                    <div className="w-16 h-16 flex items-center justify-center bg-gradient-to-br from-sienna-500 to-sienna-500 rounded-full text-white text-2xl font-bold">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <p className="text-2xl font-bold text-sienna-500">{formatCurrency(customer.lifetimeValue)}</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <div className="flex-1 bg-gray-200 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full ${customer.engagementScore >= 80 ? 'bg-sienna-500' :
                            customer.engagementScore >= 60 ? 'bg-sienna-500' :
