                ...
                <div className="bg-white p-6 rounded-lg shadow border border-gray-100">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                type="text"
                                className="w-full border rounded-md p-2 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-sienna-500 outline-none"
                        ...
                        <div>
                            ...
                            <textarea
                                className="w-full border rounded-md p-2 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-sienna-500 outline-none h-24"
                        ...
                        <button
                            ...
                            className={`w-full py-2 px-4 rounded-md text-white font-medium transition-colors ${isPending
                                    ...
                                    : 'bg-sienna-500 hover:bg-sienna-500'
                                }`}
                        >
