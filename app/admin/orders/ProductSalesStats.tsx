                    ...
                    {(['24h', '7d', '30d', 'all'] as const).map((p) => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${period === p
                                    ? 'bg-sienna-500 text-white shadow-md shadow-sienna-100'
                            ...
                            {loading ? (
                                <tr>
                                    <td colSpan={4} className="p-12 text-center text-gray-500">
                                        <i className="ri-loader-4-line text-3xl animate-spin text-sienna-500 mb-2 block"></i>
                                        Loading sales data...
                                    </td>
                                </tr>
                            ) : stats.length === 0 ? (
                                ...
                                stats.map((s) => (
                                    ...
                                    <>
                                    <tr 
                                        className={`hover:bg-cream-100/30 transition-colors ${hasVariants ? 'cursor-pointer' : ''}`}
                                    ...
                                    >
                                        ...
                                        <td className="p-4 text-center">
                                            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-sienna-50 text-sienna-600">
                                                {s.ordersCount}
                                            </span>
                                        </td>
                                        <td className="p-4 text-center">
                                            <span className="font-bold text-sienna-500 text-base">{s.itemsSold}</span>
                                        </td>
