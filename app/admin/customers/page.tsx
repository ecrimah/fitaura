...
export default function AdminCustomersPage() {
  ...
  const statusColors: any = {
    'New': 'bg-sienna-50 text-sienna-500',
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button className="bg-sienna-500 hover:bg-sienna-600 text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap cursor-pointer">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl border-2 border-gray-200 p-4">
          ...
          <p className="text-2xl font-bold text-sienna-500">{stats.newThisMonth}</p>
        </div>
        <div className="bg-white rounded-xl border-2 border-gray-200 p-4">
        ...
        {selectedCustomers.length > 0 && (
          <div className="p-4 bg-cream-100 border-b border-sienna-100 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <button className="px-4 py-2 bg-sienna-500 hover:bg-sienna-500 text-white rounded-lg text-sm font-medium transition-colors whitespace-nowrap cursor-pointer">
                ...
                filteredCustomers.map((customer) => (
                  <tr key={customer.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center space-x-3">
                        <div className="w-10 h-10 flex items-center justify-center bg-sienna-50 text-sienna-500 rounded-full font-semibold">
                          {customer.avatar}
                        </div>
                        <div>
                          <Link href={`/admin/customers/${customer.id}`} className="font-semibold text-gray-900 hover:text-sienna-500 whitespace-nowrap">
                            {customer.name}
                          </Link>
                    ...
                    <td className="py-4 px-4 font-semibold text-sienna-500 whitespace-nowrap">$ {customer.totalSpent.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center space-x-2">
                        <Link
                          ...
                          className="w-8 h-8 flex items-center justify-center text-gray-600 hover:text-sienna-500 hover:bg-cream-100 rounded-lg transition-colors"
                        >
                          <i className="ri-eye-line text-lg"></i>
                        </Link>
                        <button className="w-8 h-8 flex items-center justify-center text-gray-600 hover:text-sienna-500 hover:bg-cream-100 rounded-lg transition-colors cursor-pointer">
