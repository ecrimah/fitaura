    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
                ...
                {success && <div className="bg-cream-100 text-sienna-500 p-4 rounded-lg mb-4">{success}</div>}
                ...
                <form onSubmit={handleSend} className="space-y-6">
                    <div>
                        ...
                        <select
                            ...
                            className="w-full p-3 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-sienna-500"
                        >
                    ...
                    <div className="flex gap-6 p-4 bg-gray-50 rounded-lg border border-gray-100">
                        <label className="flex items-center gap-2 cursor-pointer">
                            <input
                                ...
                                className="w-5 h-5 text-sienna-500 rounded focus:ring-sienna-500 cursor-pointer"
                            />
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full p-3 border border-gray-300 rounded-lg h-40 outline-none focus:ring-2 focus:ring-sienna-500"
                    ...
                    <button
                        ...
                        className="w-full bg-sienna-500 text-white py-4 rounded-lg font-bold text-lg hover:bg-sienna-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                    >
                        {loading ? (
