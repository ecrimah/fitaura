      ...
      >
        <div className="h-full px-4 py-6 overflow-y-auto">
          <Link href="/admin" className="flex items-center gap-3 mb-8 px-2 cursor-pointer group">
            <span className="relative inline-flex items-center justify-center w-9 h-9 rounded-md overflow-hidden ring-1 ring-black/5 shadow-sm">
              <Image
            ...
            <span className="flex items-baseline gap-2">
              <span className="text-lg font-display tracking-wide text-ink-900 group-hover:text-sienna-500 transition-colors">FITAURA</span>
              <span className="text-[10px] font-semibold tracking-[0.18em] text-gray-500 uppercase">Admin</span>
            </span>
          </Link>
              ...
              return (
                <Link
                  ...
                  className={`flex items-center justify-between px-4 py-3 rounded-lg transition-colors cursor-pointer ${isActive
                    ? 'bg-cream-100 text-sienna-500 font-semibold'
          ...
          <div className="px-4 py-4 lg:px-6 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 lg:space-x-4">
              ...
              <div className="relative user-menu-container">
                ...
                >
                  <div className="w-8 h-8 lg:w-9 lg:h-9 flex items-center justify-center bg-sienna-50 text-sienna-500 rounded-full font-semibold">
