        ...
        <div className="bg-white rounded-t-3xl shadow-[0_-8px_40px_rgba(0,0,0,0.15)] overflow-hidden max-w-lg mx-auto">
          ...
          <div className="px-6 pb-8">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 rounded-2xl overflow-hidden shadow-lg flex-shrink-0 bg-cream-100 flex items-center justify-center">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-bold text-gray-900 text-lg truncate">FITAURA</h3>
                <p className="text-sm text-gray-500">Modern lifestyle clothing</p>
            ...
            <div className="grid grid-cols-3 gap-3 mb-6">
              {[
                ...
                >
                  <div className="w-10 h-10 bg-sienna-50 rounded-full flex items-center justify-center mx-auto mb-2">
                    <i className={`${feature.icon} text-sienna-500 text-lg`} />
                  </div>
            ...
            <button
              ...
              className="w-full bg-sienna-500 hover:bg-sienna-600 text-white py-4 px-6 rounded-2xl font-semibold text-base transition-all active:scale-[0.98] shadow-lg shadow-sienna-500/20 flex items-center justify-center gap-2"
            >
