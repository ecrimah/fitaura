            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className={`px-6 py-3 bg-sienna-500 hover:bg-sienna-600 text-white rounded-lg font-semibold transition-colors whitespace-nowrap cursor-pointer flex items-center ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
                    >
                        {loading ? (
                            <>
                        ...
                        <div className="space-y-6 max-w-3xl">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-sienna-500 focus:border-transparent transition-all"
                                />
                        ...
                        <div className="space-y-6 max-w-3xl">
                            ...
                            <div className="p-4 bg-cream-100 border border-sienna-100 rounded-lg">
                                ...
                                {price && comparePrice && parseFloat(comparePrice) > parseFloat(price) ? (
                                    ...
                                    <p className="text-sienna-600 text-sm">Enter a valid compare price higher than the price to see discount.</p>
                                )}
                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-2">
                                            <input
                                                ...
                                                className="flex-1 px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-sienna-500 focus:border-sienna-500 font-mono bg-gray-50"
                                            ...
                                            <button
                                                ...
                                                className="px-4 py-3 border-2 border-gray-300 rounded-lg hover:border-sienna-500 hover:bg-cream-100 transition-colors cursor-pointer"
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                                <h4 className="text-sm font-bold text-gray-900 mb-1 flex items-center">
                                    <i className="ri-palette-line mr-2 text-lg text-sienna-500"></i>
                                    Step 1: Select Colors
                                    {selectedColors.length > 0 && (
                                        <span className="ml-2 bg-sienna-50 text-sienna-600 text-xs font-semibold px-2 py-0.5 rounded-full">
                                    ...
                                    {colorPresets.map(color => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                ></span>
                                                <span className={isSelected ? 'text-sienna-600' : 'text-gray-700'}>{color.name}</span>
                                                {isSelected && <i className="ri-check-line text-sienna-500"></i>}
                                            </button>
                                        );
                                    })}
                                </div>
                            ...
                            <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                                <h4 className="text-sm font-bold text-gray-900 mb-1 flex items-center">
                                    <i className="ri-ruler-line mr-2 text-lg text-sienna-500"></i>
                                    Step 2: Select Sizes
                                ...
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {sizePresets.map(size => {
                                        ...
                                        return (
                                            ...
                                            >
                                                {size}
                                                {isSelected && <i className="ri-check-line ml-1.5 text-sienna-500"></i>}
                                            </button>
                                        );
                                    })}
                                </div>
                            ...
                            {variantCombinations.length > 0 && (
                                <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                                                        ...
                                                        <tr key={combo.key} className="border-b border-gray-100 hover:bg-gray-50">
                                                            ...
                                                            <td className="py-3 px-4">
                                                                <input
                                                                    ...
                                                                    className="w-28 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-1 focus:ring-sienna-500 focus:border-sienna-500"
                                                                    step="0.01"
                                                            ...
                                                            <td className="py-3 px-4">
                                                                <input
                                                                    ...
                                                                    className="w-24 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-1 focus:ring-sienna-500 focus:border-sienna-500"
                                                                    placeholder="0"
                                                                />
                                                            </td>
                                                        </tr>
                                    ...
                                    <div className="p-3 bg-cream-100 border-t border-sienna-50">
                                        <p className="text-xs text-sienna-600 flex items-center">
                    ...
                    {activeTab === 'images' && (
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <label className={`aspect-square border-2 border-dashed border-gray-300 rounded-xl hover:border-sienna-500 hover:bg-cream-100 transition-colors flex flex-col items-center justify-center space-y-2 text-gray-600 hover:text-sienna-500 cursor-pointer ${uploading ? 'opacity-50 cursor-not-allowed' : ''}`}>
                                    {uploading ? (
