      ...
      <div className="p-6 space-y-6">
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-cream-100 rounded-lg p-4">
            <p className="text-2xl font-bold text-sienna-500">{summary.imagesUploaded}</p>
            <p className="text-sm text-sienna-500">Images uploaded</p>
          </div>
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              {errorCsv && (
                <a
                  ...
                  className="text-sm text-sienna-500 hover:underline"
                >
        ...
        <div className="flex flex-wrap gap-3 pt-2">
          <Link
            href="/admin/products"
            className="inline-flex items-center gap-2 px-4 py-2 bg-sienna-500 text-white rounded-lg hover:bg-sienna-500 transition-colors"
          >
