  ...
  return (
    <>
      <button
        ...
        className="fixed left-0 top-1/2 -translate-y-1/2 bg-sienna-500 hover:bg-sienna-600 text-white p-3 rounded-r-lg shadow-lg z-[9997] transition-all"
          ...
          <div className="fixed left-0 top-0 bottom-0 w-full max-w-md bg-white shadow-2xl z-[9999] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b border-gray-200 p-4 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 flex items-center justify-center bg-sienna-50 rounded-lg">
                  <i className="ri-accessibility-line text-xl text-sienna-500"></i>
                </div>
              ...
              <div className="pt-4 border-t border-gray-200 space-y-3">
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors ${
                      settings.readableFont ? 'bg-sienna-500' : 'bg-gray-300'
                    }`}
                  >
                ...
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors ${
                      settings.hideImages ? 'bg-sienna-500' : 'bg-gray-300'
                    }`}
                  >
                    <div className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${
                ...
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors ${
                      settings.highlightLinks ? 'bg-sienna-500' : 'bg-gray-300'
                    }`}
                  >
                    <div className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${
