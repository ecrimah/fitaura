    ...
    <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-2">
          ...
          {activeFilterCount > 0 && (
            <span className="bg-sienna-500 text-white text-xs font-bold px-2 py-1 rounded-full">
              {activeFilterCount}
            </span>
          )}
        </div>
        <div className="flex items-center space-x-2">
          {activeFilterCount > 0 && (
            <button
              ...
              className="text-sm text-sienna-500 hover:text-ink-900 font-medium whitespace-nowrap"
            >
              Clear All
            </button>
          )}
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <input
                  ...
                  className="w-full px-3 py-2 border-2 border-gray-300 rounded-lg text-sm focus:border-sienna-500 focus:ring-2 focus:ring-sienna-100"
                  placeholder="Min"
                />
