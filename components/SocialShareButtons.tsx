  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg hover:border-sienna-500 hover:bg-cream-100 transition-colors"
      >
          ...
          <div className="absolute top-full right-0 mt-2 w-80 bg-white rounded-xl shadow-2xl border border-gray-100 z-50 overflow-hidden">
            ...
            <div className="p-4 grid grid-cols-4 gap-3">
              <button
                ...
                className="flex flex-col items-center gap-2 p-3 rounded-lg hover:bg-cream-100 transition-colors group"
              >
                <div className="w-12 h-12 flex items-center justify-center bg-sienna-500 text-white rounded-full group-hover:scale-110 transition-transform">
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 p-3 rounded-lg hover:bg-cream-100 transition-colors group"
              >
                <div className="w-12 h-12 flex items-center justify-center bg-sienna-400 text-white rounded-full group-hover:scale-110 transition-transform">
            ...
            <div className="p-4 border-t border-gray-100">
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-sienna-500 hover:bg-sienna-500 text-white rounded-lg font-medium transition-colors whitespace-nowrap"
                >
                  {copied ? (
                    <>
