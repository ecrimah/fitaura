  ...
  return (
    ...
    >
      ...
      <div className="relative">
        {/* Top shadow gradient */}
        <div className="absolute -top-6 left-0 right-0 h-6 bg-gradient-to-t from-cream-50/80 to-transparent pointer-events-none" />
        
        <div className="bg-cream-50/95 backdrop-blur-xl border-t border-ink-100 shadow-[0_-4px_30px_rgba(38,38,31,0.08)]">
              ...
              return (
                <Link
                  ...
                  className={`flex flex-col items-center justify-center py-2 transition-all duration-200 relative group active:scale-90 ${
                    active ? 'text-sienna-500' : 'text-ink-400'
                  }`}
                ...
                >
                  ...
                  {active && (
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-8 h-[2px] bg-sienna-500 rounded-full transition-all duration-300" />
                  )}
                  ...
                  <div className="relative w-7 h-7 flex items-center justify-center">
                    ...
                    {item.badge !== undefined && item.badge > 0 && (
                      <span className="absolute -top-1.5 -right-2 min-w-[18px] h-[18px] bg-sienna-500 text-cream-50 text-[10px] font-bold rounded-full flex items-center justify-center px-1 shadow-sm animate-scale-in">
