  ...
  return (
    <div className="fixed bottom-20 left-4 right-4 md:left-auto md:right-4 md:max-w-sm z-[9998] pwa-update-toast">
      <div className="bg-gray-900 text-white rounded-2xl p-4 shadow-2xl flex items-center gap-4">
        <div className="w-10 h-10 bg-sienna-500 rounded-xl flex items-center justify-center flex-shrink-0">
        ...
        <button
          ...
          className="bg-sienna-500 hover:bg-sienna-500 text-white px-4 py-2 rounded-xl text-sm font-semibold transition-colors flex-shrink-0 active:scale-95"
        >
          Update
        </button>
        <button
